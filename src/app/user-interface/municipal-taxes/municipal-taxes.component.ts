...
@Component({
  ...
  templateUrl: './municipal-taxes.component.html',
  styleUrls: ['./municipal-taxes.component.css'],
})
export class MunicipalTaxesComponent implements OnInit {
  ...
  login: boolean = false;
  municipalTaxesForm: FormGroup = new FormGroup({});
  ...
  constructor(
    ...
    this.municipalTaxesForm = this.fb.group({
  ...
  get getForm() {
    return this.municipalTaxesForm.controls;
  }

  municipalTaxes(formData: any) {
    this.ValidationMsg = true;
    this.submitted = true;
    this.RechargeFormData = formData;
    if (this.municipalTaxesForm.valid) {
      const data = { ...formData };
  ...
  operatorsId(value: any) {
    ...
    this.previousControls.forEach((e: string) => {
      this.municipalTaxesForm.removeControl(e);
    });
    ...
    this.municipalTaxesForm.removeControl(this.removeValue);
  }
  ...
  test1(element: any) {
    ...
    this.inputarr.forEach((input: any) => {
      ...
      this.municipalTaxesForm.addControl(
        input.Name,
