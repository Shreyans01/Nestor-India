...
export class LifeInsuranceComponent implements OnInit {
  ...
  get getForm() {
    return this.lifeInsuranceForm.controls;
  }

  lifeInsurance(formData: any) {
    this.submitted = true;
  ...
  operatorsId(value: any) {
    ...
    this.previousControls.forEach((e: string) => {
      this.lifeInsuranceForm.removeControl(e);
    });
    ...
    this.lifeInsuranceForm.removeControl(this.removeValue);
  }
  ...
  test1(element: any) {
    ...
    this.inputarr.forEach((input: any) => {
      ...
      this.lifeInsuranceForm.addControl(
        input.Name,
